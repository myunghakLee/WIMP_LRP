...
--experiment-name example_test --gpus 3 --batch-size 2 --ckpt_path experiments/example/checkpoints/epoch=122.ckpt --save_dir ResultsJson/WIMP --workers 12 --is_valid
